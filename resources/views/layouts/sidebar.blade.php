<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ set_active(['operator','kategori-pelayanan'])}}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ set_active('kategori-pelayanan') }}"><a class="nav-link" href="{{ route('kategori-pelayanan')}}">Daftar Kategori Pelayanan</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown {{ set_active(['arsip','op-berkas', 'op-buku'])}}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ set_active('op-berkas') }}"><a class="nav-link" href="{{ route('op-berkas')}}">Stock Opname Berkas</a></li>
